...
?>
<section id="testimonials" class="py-80" data-aos="fade-up">
    <div class="container">
        ...
        <div class="col-12 col-lg-4 mb-3 mb-lg-0 testimonial-column">
          <div class="testimonial-container bg-gray">
            <div class="testimonial-title-wrapper d-flex">
                <span class="test-bg testimonial-color-bg-<?php echo get_row_index(); ?>" ><?php echo the_sub_field('testimonial_name_initial');?></span>
