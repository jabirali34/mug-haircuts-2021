      ...
      <div class="col-md-6 mb-4 col-lg-4 col-xl-3 blog-recent-post text-center" data-aos="fade-up">
        <!-- IMAGE & LINK -->
        <a class="font-weight-bold  text-center" href="<?php the_permalink() ?>">
          <div class="blog-recent-featured-image post-img-box mb-3 micro">
            <img class="b-lazy" data-src="<?php get_post_thumbnail_by_size("medium"); ?>" alt="<?php get_post_thumbnail_alt() ?>">
          </div>
        </a>
        <!-- CATEGORY & LINK -->
        <?php
