      ...
      <div class="col-md-4 mb-4 mb-md-0 blog-recent-post text-center">
        <a class="font-weight-bold  text-center" href="<?php the_permalink() ?>">
          <div class="blog-recent-post-featured-image post-img-box mb-3 micro">
            <img class="b-lazy" data-src="<?php get_post_thumbnail_by_size("large"); ?>" alt="<?php get_post_thumbnail_alt(); ?>">
          </div>
        </a>
<!-- CATEGORY LINK -->
<?php
      ...
      ?>
      <div class="col-12 text-center">
        <a href="/mug-haircuts-2021/blog/" class="btn blue mt-3">View All</a>
      </div>
    </div>
  </div>
</section>