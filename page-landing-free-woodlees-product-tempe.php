 ...
 * Template Name: Free Woodlees Product Tempe
 *
 * @package start-theme
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <section class="py-80 landing-page-hero woodlees" id="anchor" data-aos="fade-up">
        <div class="container">
                ...
                <div class="col-lg-6 text-black text-center text-lg-left">
                    ...
                    <div class="main-free-haircut-text">
                        ...
                        <ol>
                            ...
                            <li style="margin-bottom: 8px;">Book any haircut at our participating Tempe location</li>
                            <li style="mb-0">Show this screenshot at time of visit</li>
                        </ol>
                        <p style="font-style: italic; line-height:33px; font-weight:400;">* MUST book through our app to redeem. Eligible for first time clients only and only valid at our 1761 E Warner Rd, Suite A-15, Tempe location. Excludes 32oz Conditioning Lotion.</p>
                    </div>
                </div>
            ...
            <img class="cta-arrow-dark tempe-arrow" style="" src="/wp-content/themes/mug-haircuts-2021/img/old-landing-pages/CTA-arrow@2x.png">
        </div>
    </section>
