...
?>');">
  <div class="container">
    <div class="row align-items-center">
      <div class="col">
        <h1><?php the_title(); ?></h1>
        <a class="mb-2 pt-0 stylesheet-go-back-to-site text-white" href="/"> <img class="b-lazy" data-src="<?php echo get_template_directory_uri(); ?>/img/arrow-left.png">Go back to site preview</a>
      </div>
    </div>
  </div>
</section>
      ...
      <div class="row row-navbar m-0" style="display:flex; justify-content:space-between; align-items:center;">
        <div class="navbar-header">
          <a class="brand" href="<?php echo home_url(); ?>">
            <img class="b-lazy" data-src="<?php echo get_template_directory_uri(); ?>/img/logo.png">
          </a>
        </div>
...
<section class="styleguide">
  ...
  <section id="hero" class="bg-hero padding-hero py-5 py-md-3" style="background-image:url('<?php echo get_template_directory_uri(); ?>/img/signa-banner.jpg')">
    <div class="container">
      ...
      <a class="scroll-link" alt="scroll link" href="#homepage-under-hero-links"><img class="b-lazy" alt="down-arrow" data-src="/wp-content/themes/mug-haircuts-2021/img/arrow-down@2x-min.png"/></a>
    </div>
  </section>
</section>
    ...
    <div class="container">
      <div class="row flex-wrap align-content-center align-items-center text-center">
        ...
        <div class="col-12 col-md-6 text-center hero-title-margin-bottom">
            <img class="b-lazy" data-src="<?php echo get_template_directory_uri(); ?>/img/Layer-2.jpg">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      ...
      <div class="row d-flex align-content-center text-left">
        <div class="col-md-4 mb-3 mb-md-0 text-center">
          ...
          <img class="b-lazy" data-src="<?php echo get_template_directory_uri(); ?>/img/Layer-2-icon.jpg">
          </div>
          <h3>icon</h3>
        ...
        <div class="col-md-4 mb-3 mb-md-0 text-center">
          <img class="b-lazy" style="max-height:230px" data-src="<?php echo get_template_directory_uri(); ?>/img/Layer-2-circle.jpg">
          <h3>circle</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
          <button href="/gallery" class="btn dark-blue font-weight-bold circular">pill button</button>
        </div>
        <div class="col-md-4 mb-3 mb-md-0 text-center">
          <img class="b-lazy" style="max-height:230px" data-src="<?php echo get_template_directory_uri(); ?>/img/Layer-2.jpg">
          <h3>square</h3>
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
          <button href="/gallery" class="btn dark-blue font-weight-bold circular">pill button</button>
        </div>
    ...
    <div class="container">
      ...
      <div class="row d-flex align-content-center text-left">
        <div class="col-md-6 mb-3 mb-md-0 text-center">
          <img class="rounded b-lazy" data-src="<?php echo get_template_directory_uri(); ?>/img/Layer-2.jpg">
        </div>
