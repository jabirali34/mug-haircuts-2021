 ...
 * Template Name: Free Haircut Offer Tempe
 *
 * @package start-theme
 */
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 text-white text-center text-lg-left">
                    ...
                    <div class="main-free-haircut-text">
                        ...
                        <p style="font-size: 20px;font-style: italic; font-weight:300;">* MUST book through our app to redeem. Eligible for first time clients only and only valid at our 1761 E Warner Rd, Suite A-15, Tempe location.</p>
                    </div>
                </div>
