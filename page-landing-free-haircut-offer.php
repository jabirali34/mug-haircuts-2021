 ...
 * Template Name: Free Haircut Offer
 *
 * @package start-theme
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <section class="py-5 landing-page-hero" id="anchor" data-aos="fade-up">
        <div class="container alternating-page-layout">
            <div class="row align-items-center">
                <div class="col-lg-7 text-white text-center text-lg-left">
                    <h1>Get a <span>FREE MUG CUT</span></h1>
                    <div class="main-free-haircut-text">
                        ...
                        <ol>
                            ...
                            <li style="margin-bottom: 8px;">Book "The MUG Cut" at our participating locations</li>
                            <li>Show this screenshot at time of visit</li>
                        </ol>
                        <p style="font-size: 20px;font-style: italic; font-weight:300;">* MUST book through our app to
                            redeem. Eligible
                            for first time clients only and only valid at participating locations.</p>
                    </div>
                </div>
                <div class="col-lg-5 text-center">
                    <img style=" width: 186px; padding-bottom: 35px;" class="ios-app"
                        src="/wp-content/themes/mug-haircuts-2021/img/old-landing-pages/mug-app-iphone-and-screenshot-updated.png">
                    <div class="download-apps-container d-flex justify-content-center"><a class="fb-apple-button-event"
                            style="width: 100%;margin-right: 15px;max-width: 186px;"
                            ...
                            class="fb-google-button-event" style="width:100%;    max-width: 186px;"
                    ...
                    <img class="arrow" src="/wp-content/themes/mug-haircuts-2021/img/old-landing-pages/mug-arrow-apps2x.png">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5 locations-section" data-aos="fade-up">
        <div class="container alternating-page-layout">
            <div class="row align-items-center text-center">
                ...
                <div class="col-12 justify-content-center"><a class="blue-book-btn" href="#anchor">Book Your
                        Appointment</a></div>
            </div>
        </div>
    </section>
    ...
    <section class="py-80" style="background-color:#282828;" data-aos="fade-up">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 justify-content-center text-center"><a class="blue-book-btn" href="#anchor">Book Your
                        Appointment</a></div>
            </div>
        </div>
    </section>
