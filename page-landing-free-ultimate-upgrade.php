 ...
 * Template Name: Free Ultimate Upgrade
 *
 * @package start-theme
 */
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <section class="py-5 landing-page-hero ultimate-upgrade" id="anchor" data-aos="fade-up">
        <div class="container alternating-page-layout">
            <div class="row align-items-center">
                <div class="col-lg-7 text-white text-center text-lg-left">
                    <h1>Free <span>Ultimate Upgrade</span> With Any Haircut</h1>
                    <div class="main-free-haircut-text">
                        ...
                        <ol>
                            ...
                            <li style="margin-bottom: 8px;">Select both haircut and "Ultimate Upgrade"</li>
                            <li>Present screenshot of offer at time of visit</li>
                        </ol>
                        <p style="font-size: 20px;font-style: italic; font-weight:300;">* MUST book through our app to redeem. Eligible for first time clients only. Free Ultimate Upgrade includes Shampoo, Conditioner, Scalp Massage, Hot Steamed Towel, Facial Massage, and/or Beard Revitalization, a $10 value.</p>
                    </div>
                </div>
