  ...
  <div class="sl-item" data-id="{{:id}}">
    ...
    <div class="row">
      <div class="mt-10 distance">
          <div class="col-xs-6 d-xl-flex">
            <p class="p-direction"><button type="button" class="btn btn-asl s-direction"><?php echo __( 'Directions','asl_locator') ?></button></p>
            {{if website}}
                <a class="btn-asl mt-1 mt-xl-0 ml-xl-1" style="text-transform:unset;" target="self" href="{{:website}}">View Location</a>
            {{/if}}
          </div>
          {{if dist_str}}
          <div class="col-xs-6">
...
<script id="asl_too_tip" type="text/x-jsrender">
  ...
  {{if website}}
  <a href="{{:website}}" class="action a-website">View Location</a>
  {{/if}}
  </div>
